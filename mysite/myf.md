...
ユーザー->webサーバー:人気商品ランキング表示
webサーバー->DBサーバー:人気商品ランキング処理
DBサーバー->DBサーバー:人気商品ランキング処理
DBサーバー->webサーバー:処理結果
webサーバー->ユーザー:処理結果

ユーザー->webサーバー:商品仮想組立表示
webサーバー->DBサーバー:商品仮想組立処理
DBサーバー->DBサーバー:商品仮想組立処理
DBサーバー->webサーバー:処理結果
webサーバー->ユーザー:処理結果
